...
-(NSString*)toJson
{
    ...
    NSString *bubbleText = ((UILabel*)self.view).text;
    
    NSString *bubbleAvatarImgUrl = @"";
    
    if(self.imageUrl != nil)
    {
        bubbleAvatarImgUrl =self.imageUrl;
    }
    ...
    NSString *bubbleDate = [dateFormatter stringFromDate:self.date];
    ...
    [toJsonDict setObject:bubbleDate forKey:@"date"];
    [toJsonDict setObject:bubbleType forKey:@"type"];
    
    
    return [toJsonDict JSONString];
